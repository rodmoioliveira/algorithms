...
pub fn roman_to_int(s: String) -> i32 {
    ...
    let t: HashMap<char, i32> = HashMap::from_iter(vec![
        ('I', 1),
        ('V', 5),
        ('X', 10),
        ('L', 50),
...
pub fn testcase() {
    let res = roman_to_int(String::from("MCMXCIV"));
...
mod tests {
    ...
    #[test]
    fn test_1() {
        let res = roman_to_int(String::from("III"));
        let expected = 3;
    ...
    #[test]
    fn test_2() {
        let res = roman_to_int(String::from("LVIII"));
        let expected = 58;
        assert_eq!(res, expected);
    }
    ...
    #[test]
    fn test_4() {
        let res = roman_to_int(String::from("MMIX"));
        let expected = 2009;
        assert_eq!(res, expected);
    }
}
