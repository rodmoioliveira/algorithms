...
pub fn close_strings(word1: String, word2: String) -> bool {
    ...
    for l in word1.chars() {
        w1.entry(l).and_modify(|v| *v += 1).or_insert(1);
    }

    for l in word2.chars() {
        w2.entry(l).and_modify(|v| *v += 1).or_insert(1);
    }
...
mod tests {
    ...
    #[test]
    fn test_1() {
        let res = close_strings("abc".to_owned(), "bca".to_owned());
        let expected = true;
    ...
    #[test]
    fn test_2() {
        let res = close_strings("a".to_owned(), "aa".to_owned());
        let expected = false;
        assert_eq!(res, expected);
    }
    ...
    #[test]
    fn test_3() {
        let res = close_strings("cabbba".to_owned(), "abbccc".to_owned());
        let expected = true;
        assert_eq!(res, expected);
    }
