// REFERENCES:
//
// - [Bentley1999] Jon L. Bentley. Programming Pearls. Addison-Wesley, second edition, 1999.
...
// - [Hoare1962] C. A. R. Hoare. Quicksort. The Computer Journal, 5(1):10315, 1962.
...
// [CLRS2009, p.204]
// Quicksort was invented by [Hoare1962], and his version of PARTITION appears in Problem 7-1.
// [Bentley1999, p. 117] attributes the PARTITION procedure given in Section 7.1 to N. Lomuto.
...
pub fn example() {
    let mut res = vec![10, 23, 51, 18, 4, 31, 5, 13];
    lomuto_clrs(&mut res);
